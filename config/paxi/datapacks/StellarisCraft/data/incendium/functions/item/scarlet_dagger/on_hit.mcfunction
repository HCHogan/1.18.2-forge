...
execute if predicate incendium:random/75 run effect give @s regeneration 5 1

execute if predicate incendium:random/20 run effect give @s instant_health 1 1
